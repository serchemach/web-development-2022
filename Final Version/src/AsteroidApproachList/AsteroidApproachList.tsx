...
export type AsteroidApproachListProps = {
    asteroidInfo: Asteroid;
};

export const AsteroidApproachList = (props: AsteroidApproachListProps) => {
    ...
    return (
        <div className={styles.pageContainer}>
            ...
            {closeApproaches.map((item: CloseApproach) => (
                <ApproachElement approach={item} key={asteroidInfo.id + ' ' + item.approachDate} />
            ))}
        </div>
    );
};
